...
class UltimateConverterApp:
    ...
    def _build_gui(self):
        ...
        ttk.Entry(lang_frame, textvariable=self.src_lang_var, width=12).pack(side=tk.LEFT, padx=(5, 20))
        
        self.lbl_tgt = ttk.Label(lang_frame)
        self.lbl_tgt.pack(side=tk.LEFT)
        ttk.Entry(lang_frame, textvariable=self.tgt_lang_var, width=12).pack(side=tk.LEFT, padx=(5, 0))
